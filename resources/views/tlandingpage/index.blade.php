    ...
    <div class="wpo-breacking-news section-padding bg-reds bg-img-overlay item1-img py-4">
        <div class="container">
            <div class="wpo-section-title text-center mb-4">
                ...
                <p class="text-white my-0 fs-5">Informasi Standar Pelayanan Perizinan {{$Perizinan->count()}} Teratas</p>
            ...
            <div class="text-center">
                <a href="{{ route('perizinan') }}" class="btn btn-warning fw-bold text-dark shadow-lg">
